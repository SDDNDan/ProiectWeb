    ...
    <header>
        ...
        <div class="content">
            <ul class="link__header_prop">
                <li class = "link__header"><a class = "list__link" href="home.phpblic_html/index.php">Home</a> </li>
                <li class = "link__header"><a class = "list__link" href="courses.php">Courses</a></li>
                <li class = "link__header"><a class = "list__link" href="GradeStatistics.phpndex.php">Grade & Statistics</a></li>
                <li class = "link__header"><a class = "list__link" href="about.phplic_html/index.php">About</a></li>
                <li class = "link__header"><a class = "list__link" href="contact.phpc_html/index.php">Contact</a></li>
            </ul>
        </div>
        <div class = "dropdown">
